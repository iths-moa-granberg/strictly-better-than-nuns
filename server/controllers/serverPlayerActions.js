...
io.on('connection', socket => {
    ...
    const playerStepOptions = () => {
        ...
        if (socket.game.isCaught(socket.player)) {
            possibleSteps = socket.game.board.getClosestWayHome(socket.player.position, socket.player.home, socket.player.hasKey);
        } else {
            possibleSteps = socket.game.board.getReachable(socket.player.position, socket.player.stepsLeft, socket.player.hasKey);
        }
